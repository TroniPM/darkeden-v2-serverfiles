...
// by sigi. 2002.11.18. ¡¶«—¿˚ π´∑· ªÁøÎ¿⁄. - -; ¿œ¥‹ login
	...
	{
		// PC finderø°º≠ ø°∑Ø∞° ¿⁄≤Ÿ ∂ﬂ¥¬µ•, ±◊≥… ø©±‚º≠ ¿‚æ∆¡÷∏È µ«¡ˆ æ ¿ª±Ó?
		// by ±Ëº∫πŒ
		// ø©±‚º≠ ≈©∏Æ√ƒ ∞¥√º∏¶ ¡ˆøˆπˆ∏Æ∏È, ∞‘¿” «√∑π¿ÃæÓ∞° ∞°¡ˆ∞Ì ¿÷¥¬ m_pCreature ∆˜¿Œ≈Õ¥¬
		// ∞°∫Ò¡ˆ ∞™¿ª ∞°∏£≈∞∞‘ µ»¥Ÿ. ±◊∑°º≠ GamePlayer::~GamePlayer() ø°º≠ ¿⁄Ω≈¿« m_pCreature∏¶ ªË¡¶«“ ∂ß
		// ¿ﬂ∏¯µ» ∏ﬁ∏∏Æ øµø™¿ª ¬¸¡∂«œ∏Èº≠ ¡◊∞‘ µ»¥Ÿ. ±◊∑Øπ«∑Œ ¡÷ºÆ¿ª «Æ¡ˆ ∏ª ∞Õ.

		// GamePlayer∏¶ ¡ˆøÏ∏Èº≠ 
		// m_pCreature∞° ¿÷¥¬ ∞ÊøÏø°¥¬ PCFinder¡ˆøˆ¡÷¥¬µ•..
		// ¿Ã∞Õ∂ßπÆø° ∏÷∆º ∑Œ±◊¿Œ¿Ã ∞°¥…«œ∞‘ µ»¥Ÿ.
		// ¿Ã∞… ∏∑±‚ ¿ß«ÿº≠ ƒ≥∏Ø≈Õ∏¶ ø©±‚º≠ ¡ˆøˆ¡ÿ¥Ÿ.
		// by sigi. 2002.5.9

		// »§Ω√ PCFinderø°º≠ æ» ¡ˆøˆ¡÷∞Ì ∞¥√º∏∏ ¡ˆøÏ∏È
		// PCFinderø°º≠ ¿–æÓø¬ pointer∞° deleteµ»∞≈∂Ûº≠ πÆ¡¶∞° ª˝±‰¥Ÿ∞Ì ª˝∞¢«ﬂ¥¬µ•
		// ∫–∏Ì»˜ GamePlayer∞° deleteµ…∂ß¥¬ PCFinderø°º≠ ¡¶∞≈«ÿ¡÷∞Ì
		// ø©±‚º≠ ¡ˆøÏ¥¬ ƒ≥∏Ø≈Õ¥¬ ¿ÃπÃ ¡¢º”µ» ƒ≥∏Ø≈ÕøÕ¥¬ ∞¸∞Ëæ¯¥¬ ªı∑ŒøÓ ∞¥√º¿Ãπ«∑Œ
		// ªÛ∞¸¿Ã æ¯¥Ÿ. 2002.8.29. by sigi
		SAFE_DELETE(pSlayer);
	...
	*/
	...
	else
	{
		...
		cout << "ø£«¡∑Œ≈ÿ∆Æ ¿Œ¡ı ≈∏¿Ã∏” ∫Ÿ¿‘¥œ¥Ÿ : " << pGamePlayer->getID() << eos;
#endif
	}
...
//	pGamePlayer->sendPacket( SystemAvailabilitiesManager::getInstance()->getAvailabilitiesPacket() );
	...
	//filelog("Ousters.txt","CGConnectHandler.cpp");
