...
DynamicZoneMenegroth3::DynamicZoneMenegroth3()
{
	m_MonoObjectID = 0;
	m_CabracamHP = 0;
}
...
void DynamicZoneMenegroth3::init()
{
	Assert( m_pZone != NULL );
...
void DynamicZoneMenegroth3::heartbeat()
{
	switch ( m_OMOAStatus )
	{
	case WAIT_FOR_PC:
...
bool DynamicZoneMenegroth3::checkPC()
{
	Assert( m_pZone != NULL );
...
bool DynamicZoneMenegroth3::addMonster()
{
	Assert( m_pZone != NULL );
...
bool DynamicZoneMenegroth3::addMonster_boss_regen()
{
	Assert( m_pZone != NULL );
...
bool DynamicZoneMenegroth3::addMono()
{
	Assert( m_pZone != NULL );
...
bool DynamicZoneMenegroth3::clearMono()
{
	Assert( m_pZone != NULL );
...
bool DynamicZoneMenegroth3::checkMonoHPcount()
{
	Assert( m_pZone != NULL );
...
bool DynamicZoneMenegroth3::checkMonoEffect()
{
	Assert( m_pZone != NULL );
...
bool DynamicZoneMenegroth3::openGateToOut()
{
	Assert( m_pZone != NULL );
...
bool DynamicZoneMenegroth3::openGateToOutNextStage()
{
	Assert( m_pZone != NULL );

	int targetDynamicZoneType = g_pDynamicZoneInfoManager->getDynamicZoneTypeByZoneID( 1704 );
	...
	DynamicZoneMenegroth4* pAlterOfBlood = dynamic_cast<DynamicZoneMenegroth4*>(pDynamicZone);
	...
	m_pZone->getPCManager()->transportAllCreatures( pDynamicZone->getZoneID(), 56, 20 );
        }
    }
...
void DynamicZoneMenegroth3::timecheck()
{
...
bool DynamicZoneMenegroth3::checkComplete()
{
	Timeval current;
	getCurrentTime( current );
...
void DynamicZoneMenegroth3::processEntering()
{
	Assert( m_pZone != NULL );
...
bool DynamicZoneMenegroth3::checkMonster()
{
	Assert( m_pZone != NULL );
...
bool DynamicZoneMenegroth3::checkbossmonster()
{
	Assert( m_pZone != NULL );
...
bool DynamicZoneMenegroth3::checkMono()
{
	Assert( m_pZone != NULL );
...
bool DynamicZoneMenegroth3::clearMonster()
{
...
void DynamicZoneMenegroth3::TreasureCheck()
{
...
void DynamicZoneMenegroth3::killPC()
{
	Assert( m_pZone != NULL );
...
DEFINE_DYNAMIC_ZONE_FACTORY( DynamicZoneMenegroth3, DYNAMIC_ZONE_MENEGROTH3 )
