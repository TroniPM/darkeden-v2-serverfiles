...
// Rebuke 명중굴림 함수
//////////////////////////////////////////////////////////////////////////////
bool HitRoll::isSuccessMistOfSoul(Ousters* pOusters, OustersSkillSlot* pSkillSlot, Creature* pDefender)
{
	if( pDefender->isOusters() ) return false;
	...
	Attr_t			INTE		= pOusters->getINT(ATTR_CURRENT);
	SkillLevel_t	SkillLevel	= pSkillSlot->getExpLevel();
...
// Rebuke 명중굴림 함수
//////////////////////////////////////////////////////////////////////////////
bool HitRoll::isSuccessVenom(Vampire* pVampire, VampireSkillSlot* pVampireSkillSlot, Creature* pDefender)
{
	if( pDefender->isVampire() ) return false;
	...
	Attr_t			INTE		= pVampire->getINT(ATTR_CURRENT);

	int ratio = 20 + ( INTE / 5 ) + ( 100 / 2 );
	if (rand()%100 < ratio ) return true;
	return false;
}
