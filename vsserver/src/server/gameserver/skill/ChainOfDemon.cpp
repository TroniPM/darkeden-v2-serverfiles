...
// 뱀파이어 오브젝트 핸들러
//////////////////////////////////////////////////////////////////////////////
void ChainOfDemon::execute(Vampire* pVampire, ObjectID_t TargetObjectID, VampireSkillSlot* pVampireSkillSlot, CEffectID_t CEffectID)
	throw(Error)
{
	__BEGIN_TRY
	...
	try 
	{
		...
		if (pTargetCreature==NULL
			...
			|| pTargetCreature->isNPC() || pVampire->getINT(ATTR_BASIC) >= 100)
		{
		...
		bool bEffected   = pTargetCreature->isFlag(Effect::EFFECT_CLASS_CHAIN_OF_DEMON);
...
*/
			...
			pEffectChainOfDemon->setNextTime(0);
			pEffectChainOfDemon->setCasterID( pVampire->getObjectID() );
			pEffectChainOfDemon->setDamage( output.Damage );
