...
//////////////////////////////////////////////////////////////////////////////
//////////////////////////////////////////////////////////////////////////////
EffectViaCrucis::EffectViaCrucis(Zone* pZone, ZoneCoord_t zoneX, ZoneCoord_t zoneY) 
	throw(Error)
{
	__BEGIN_TRY
...
void EffectViaCrucis::checkPosition()
{
	__BEGIN_TRY
		...
		for (; itr != oList.end(); itr++) 
		{
			...
			if (pObject->getObjectClass() == Object::OBJECT_CLASS_CREATURE)
			{
				...
				if ( pCastCreature != NULL &&
					...
					|| !canHit( pCastCreature, pCreature, SKILL_VIA_CRUCIS ) )
				)
				{
					continue;
				}
...
//							damage = m_Damage;
					...
					if (pCreature->isVampire())
					{
						...
						::setDamage( pVampire, damage, pCastCreature, SKILL_VIA_CRUCIS, &gcDefenderMI, &gcAttackerMI, true, false );
					...
					else if (pCreature->isOusters()) 
					{
						...
						::setDamage( pOusters, damage, pCastCreature, SKILL_VIA_CRUCIS, &gcDefenderMI, &gcAttackerMI, true, false );
					...
					else if (pCreature->isMonster())
					{
						...
						::setDamage( pMonster, damage, pCastCreature, SKILL_VIA_CRUCIS, NULL, &gcAttackerMI, true, false );
					}
...
//////////////////////////////////////////////////////////////////////////////
//////////////////////////////////////////////////////////////////////////////
string EffectViaCrucis::toString()
	const throw()
{
	__BEGIN_TRY
