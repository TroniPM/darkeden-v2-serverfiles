...
SkillInput::SkillInput(Slayer* pSlayer, SkillSlot* pSkillSlot)
{
	...
	if(pSkillInfo->getSkillSTR() > 0)Damage += STR/pSkillInfo->getSkillSTR();
	if(pSkillInfo->getSkillDEX() > 0)Damage += DEX/pSkillInfo->getSkillDEX();
	if(pSkillInfo->getSkillINT() > 0)Damage += INTE/pSkillInfo->getSkillINT();
