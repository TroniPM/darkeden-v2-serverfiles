...
{
public:
	TiffaugesGusionARed() throw() {}
	~TiffaugesGusionARed() throw() {}
	
public:
    string getSkillHandlerName() const throw() { return "TiffaugesGusionARed"; }

	SkillType_t getSkillType() const throw() { return SKILL_TIFFAUGES_GUSION_A_RED; }
