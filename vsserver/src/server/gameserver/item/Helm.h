...
class Helm : public ConcreteItem<Item::ITEM_CLASS_HELM, NoStack, HasDurability, HasOption, GroceryGrade, NoAttacking, NoEnchantLevel, HasOption2, HasHeroOption, HasHeroOptionAttr>
{
public:
	Helm() throw();
	Helm(ItemType_t itemType, const list<OptionType_t>& optionType) throw();
...
public:
//	virtual ItemClass getItemClass() const throw() { return Item::ITEM_CLASS_HELM; }
//	virtual string getObjectTableName() const throw() { return "HelmObject"; }
...
{
public:
	virtual Item::ItemClass getItemClass() const throw() { return Item::ITEM_CLASS_HELM; }
...
public:
	virtual Item::ItemClass getItemClass() const throw() { return Item::ITEM_CLASS_HELM; }
	virtual string getItemClassName() const throw() { return "Helm"; }
	
public:
	virtual Item* createItem(ItemType_t ItemType, const list<OptionType_t>& OptionType) throw() { return new Helm(ItemType,OptionType); }
};
