...
public:
//	virtual ItemClass getItemClass() const throw() { return Item::ITEM_CLASS_OUSTERS_PENDENT; }
//	virtual string getObjectTableName() const throw() { return "OustersPendentObject"; }
...
{
public:
	virtual Item::ItemClass getItemClass() const throw() { return Item::ITEM_CLASS_OUSTERS_PENDENT; }
...
public:
	virtual Item::ItemClass getItemClass() const throw() { return Item::ITEM_CLASS_OUSTERS_PENDENT; }
	virtual string getItemClassName() const throw() { return "OustersPendent"; }
