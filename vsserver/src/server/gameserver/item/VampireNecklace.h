...
class VampireNecklace : public ConcreteItem<Item::ITEM_CLASS_VAMPIRE_NECKLACE, NoStack, HasDurability, HasOption, AccessoryGrade, NoAttacking,  NoEnchantLevel, HasOption2, HasHeroOption, HasHeroOptionAttr>
{
public:
	VampireNecklace() throw();
	VampireNecklace(ItemType_t itemType, const list<OptionType_t>& optionType) throw();
...
public:
//	virtual ItemClass getItemClass() const throw() { return Item::ITEM_CLASS_VAMPIRE_NECKLACE; }
//	virtual string getObjectTableName() const throw() { return "VampireNecklaceObject"; }
...
{
public:
	virtual Item::ItemClass getItemClass() const throw() { return Item::ITEM_CLASS_VAMPIRE_NECKLACE; }
...
public:
	virtual Item::ItemClass getItemClass() const throw() { return Item::ITEM_CLASS_VAMPIRE_NECKLACE; }
	virtual string getItemClassName() const throw() { return "VampireNecklace"; }
	
public:
	virtual Item* createItem(ItemType_t ItemType, const list<OptionType_t>& OptionType) throw() { return new VampireNecklace(ItemType,OptionType); }
};
