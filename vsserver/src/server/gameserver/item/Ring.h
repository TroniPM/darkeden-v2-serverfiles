...
public:
//	virtual ItemClass getItemClass() const throw() { return Item::ITEM_CLASS_RING; }
//	virtual string getObjectTableName() const throw() { return "RingObject"; }
...
{
public:
	virtual Item::ItemClass getItemClass() const throw() { return Item::ITEM_CLASS_RING; }
...
public:
	virtual Item::ItemClass getItemClass() const throw() { return Item::ITEM_CLASS_RING; }
	virtual string getItemClassName() const throw() { return "Ring"; }
