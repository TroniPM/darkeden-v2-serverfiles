...
class OustersRing : public ConcreteItem<Item::ITEM_CLASS_OUSTERS_RING, NoStack, HasDurability, HasOption, AccessoryGrade, NoAttacking, NoEnchantLevel, HasOption2, HasHeroOption, HasHeroOptionAttr>
{
public:
	OustersRing() throw();
	OustersRing(ItemType_t itemType, const list<OptionType_t>& optionType) throw();
...
public:
//	virtual ItemClass getItemClass() const throw() { return Item::ITEM_CLASS_OUSTERS_RING; }
//	virtual string getObjectTableName() const throw() { return "OustersRingObject"; }
...
{
public:
	virtual Item::ItemClass getItemClass() const throw() { return Item::ITEM_CLASS_OUSTERS_RING; }
...
public:
	virtual Item::ItemClass getItemClass() const throw() { return Item::ITEM_CLASS_OUSTERS_RING; }
	virtual string getItemClassName() const throw() { return "OustersRing"; }

public:
	virtual Item* createItem(ItemType_t ItemType, const list<OptionType_t>& OptionType) throw() { return new OustersRing(ItemType,OptionType); }
};
