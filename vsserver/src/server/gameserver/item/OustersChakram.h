...
public:
//	virtual ItemClass getItemClass() const throw() { return Item::ITEM_CLASS_OUSTERS_CHAKRAM; }
//	virtual string getObjectTableName() const throw() { return "OustersChakramObject"; }
...
{
public:
	virtual Item::ItemClass getItemClass() const throw() { return Item::ITEM_CLASS_OUSTERS_CHAKRAM; }
...
public:
	virtual Item::ItemClass getItemClass() const throw() { return Item::ITEM_CLASS_OUSTERS_CHAKRAM; }
	virtual string getItemClassName() const throw() { return "OustersChakram"; }
	
public:
	virtual Item* createItem(ItemType_t ItemType, const list<OptionType_t>& OptionType) throw() { return new OustersChakram(ItemType,OptionType); }
};
