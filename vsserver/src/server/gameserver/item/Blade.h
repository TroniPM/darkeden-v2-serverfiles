...
public:
	Blade() throw();
	Blade(ItemType_t itemType, const list<OptionType_t>& optionType) throw();
...
public:
//	virtual ItemClass getItemClass() const throw() { return Item::ITEM_CLASS_BLADE; }
//	virtual string getObjectTableName() const throw() { return "BladeObject"; }
...
{
public:
	virtual Item::ItemClass getItemClass() const throw() { return Item::ITEM_CLASS_BLADE; }
...
public:
	virtual Item::ItemClass getItemClass() const throw() { return Item::ITEM_CLASS_BLADE; }
	virtual string getItemClassName() const throw() { return "Blade"; }
	
public:
	virtual Item* createItem(ItemType_t ItemType, const list<OptionType_t>& OptionType) throw() { return new Blade(ItemType,OptionType); }
};
