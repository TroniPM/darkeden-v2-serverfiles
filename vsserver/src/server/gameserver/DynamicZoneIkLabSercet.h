...
#ifndef __DYNAMIC_ZONE_IK_LAB_SERCET_H__
#define __DYNAMIC_ZONE_IK_LAB_SERCET_H__
...
///////////////////////////////////////////////////////////
class DynamicZoneIkLabSercet : public DynamicZone
{
public:
	DynamicZoneIkLabSercet();
	virtual ~DynamicZoneIkLabSercet();
...
DECLARE_DYNAMIC_ZONE_FACTORY( DynamicZoneIkLabSercet )
