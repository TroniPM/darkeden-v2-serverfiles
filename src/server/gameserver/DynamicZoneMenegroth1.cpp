...
DynamicZoneMenegroth1::DynamicZoneMenegroth1()
{
	m_MonoObjectID = 0;
	m_CabracamHP = 0;
}
...
void DynamicZoneMenegroth1::init()
{
	Assert( m_pZone != NULL );
...
void DynamicZoneMenegroth1::heartbeat()
{
	switch ( m_OMOAStatus )
	{
	case WAIT_FOR_PC:
...
bool DynamicZoneMenegroth1::checkPC()
{
	Assert( m_pZone != NULL );
...
bool DynamicZoneMenegroth1::addMonster()
{
	Assert( m_pZone != NULL );
...
bool DynamicZoneMenegroth1::addMonster_boss_regen()
{
	Assert( m_pZone != NULL );
...
bool DynamicZoneMenegroth1::addMono()
{
	Assert( m_pZone != NULL );
...
bool DynamicZoneMenegroth1::clearMono()
{
	Assert( m_pZone != NULL );
...
bool DynamicZoneMenegroth1::checkMonoHPcount()
{
	Assert( m_pZone != NULL );
...
bool DynamicZoneMenegroth1::checkMonoEffect()
{
	Assert( m_pZone != NULL );
...
bool DynamicZoneMenegroth1::openGateToOut()
{
	Assert( m_pZone != NULL );
...
bool DynamicZoneMenegroth1::openGateToOutNextStage()
{
	Assert( m_pZone != NULL );

	int targetDynamicZoneType = g_pDynamicZoneInfoManager->getDynamicZoneTypeByZoneID( 1702 );
	...
	DynamicZoneMenegroth2* pAlterOfBlood = dynamic_cast<DynamicZoneMenegroth2*>(pDynamicZone);
	...
	m_pZone->getPCManager()->transportAllCreatures( pDynamicZone->getZoneID(), 22, 54 );
        }
    }
...
bool DynamicZoneMenegroth1::clearMonster()
{
...
void DynamicZoneMenegroth1::timecheck()
{
...
bool DynamicZoneMenegroth1::checkComplete()
{
	Timeval current;
	getCurrentTime( current );
...
void DynamicZoneMenegroth1::processEntering()
{
	Assert( m_pZone != NULL );
...
bool DynamicZoneMenegroth1::checkMonster()
{
	Assert( m_pZone != NULL );
...
bool DynamicZoneMenegroth1::checkbossmonster()
{
	Assert( m_pZone != NULL );
...
bool DynamicZoneMenegroth1::checkMono()
{
	Assert( m_pZone != NULL );
...
void DynamicZoneMenegroth1::TreasureCheck()
{
...
void DynamicZoneMenegroth1::killPC()
{
	Assert( m_pZone != NULL );
...
DEFINE_DYNAMIC_ZONE_FACTORY( DynamicZoneMenegroth1, DYNAMIC_ZONE_MENEGROTH1 )
