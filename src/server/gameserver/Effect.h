...
public:
	enum EffectClass 
	{
		...
		EFFECT_CLASS_BLOOD_BLLODY_SCARIFY,			// ÑªÖ®ÀÓÓ¡(ÎüÑª¹í) 465
		EFFECT_CLASS_BLOOD_CURSE,					// ÑªÖ®?Öä(ÎüÑª¹í) 466
		EFFECT_CLASS_SKILL_BOMB_CRASH_WALK_TO_ENEMY,  //467
		EFFECT_CLASS_SKILL_SATELLITE_BOMB_AIM,		  // ÎÀÐÇºä»÷ Ð§¹û¶¨Òå (ÈËÀà) 468
		EFFECT_CLASS_SKILL_SATELLITE_BOMB_POINT,      // ÎÀÐÇºä»÷ Ð§¹û¶¨Òå (ÈËÀà)469
		EFFECT_CLASS_SKILL_SATELLITE_BOMB_FIRE,          // ¿ªÇ¹Ð§¹û470
		EFFECT_CLASS_HEAVEN_GROUND,					 // ·¨Ê¦ÌìÉñ½µÁÙ471
		EFFECT_CLASS_DUMMY_DRAKE,					 // µÂÀ×¿Ë¿þÀÜ(Ä§Áé)472
		EFFECT_CLASS_HYDRO_CONVERGENCE,				//  ¸´ºÏË®ÁÆ473
		EFFECT_CLASS_SUMMON_CLAY,				//  Summon Clay  Õ³ÍÁÕÙ»½    (Ä§ÁéÐÂ¼¼ÄÜ ÍÁ·¨)474
		EFFECT_CLASS_HETER_CHAKRAM,				//  Heter Chakram ÏÄ²¼Àû»ùÒò  (Ä§ÁéÐÂ¼¼ÄÜ  Õ½Ê¿)475
                	EFFECT_CLASS_Bramble_Halo, // 476
                	EFFECT_CLASS_Fire_Meteor, // 477
                	EFFECT_CLASS_Penetrate_Wheel, //478
               	EFFECT_CLASS_Rapid_Freeze, // 479
               	EFFECT_CLASS_XRL_Missile,	 // 480
               	EFFECT_CLASS_ROCKET_LAUNCHER2, // Å¬¶óÀÌ¾ðÆ® Àü¿ë 481
		EFFECT_CLASS_EAGLES_EYE1, // 482 ÀÌ±Û¾ÆÀÌ 1
		EFFECT_CLASS_EAGLES_EYE2, // 483 ÀÌ±Û¾ÆÀÌ 2
		EFFECT_CLASS_MAGIC_SHIELD1, // 482 ÀÌ±Û¾ÆÀÌ 1
		EFFECT_CLASS_MAGIC_SHIELD2, // 483 ÀÌ±Û¾ÆÀÌ 2
		EFFECT_CLASS_BLOODY_SHOUT1, // 482 ÀÌ±Û¾ÆÀÌ 1
		EFFECT_CLASS_BLOODY_SHOUT2, // 483 ÀÌ±Û¾ÆÀÌ 2
		EFFECT_CLASS_FREEZE_RING1, // 482 ÀÌ±Û¾ÆÀÌ 1
		EFFECT_CLASS_CURSE_OF_BLOOD1, // 482 ÀÌ±Û¾ÆÀÌ 1
		EFFECT_CLASS_CURSE_OF_BLOOD_GROUND, // 482 ÀÌ±Û¾ÆÀÌ 1
		EFFECT_CLASS_BLOOD_DRAIN2,				 // 23
		EFFECT_CLASS_MIST_OF_SOUL1, // 482 ÀÌ±Û¾ÆÀÌ 1
		EFFECT_CLASS_ENERGY_BURST, // 483 ÀÌ±Û¾ÆÀÌ 2
		EFFECT_CLASS_BAT_STORM, // 483 ÀÌ±Û¾ÆÀÌ 2
		EFFECT_CLASS_STORM_BAT, // 483 ÀÌ±Û¾ÆÀÌ 2
		EFFECT_CLASS_SQUALLY_BARRIER1, // 483 ÀÌ±Û¾ÆÀÌ 2
		EFFECT_CLASS_SQUALLY_BARRIER1_BACK, // 483 ÀÌ±Û¾ÆÀÌ 2
		EFFECT_CLASS_SQUALLY_BARRIER2, // 483 ÀÌ±Û¾ÆÀÌ 2
		EFFECT_CLASS_SQUALLY_BARRIER2_BACK, // 483 ÀÌ±Û¾ÆÀÌ 2
		EFFECT_CLASS_MAGMA_DETONATION1, // 483 ÀÌ±Û¾ÆÀÌ 2
		EFFECT_CLASS_GLADIATOR, // 483 ÀÌ±Û¾ÆÀÌ 2
		EFFECT_CLASS_CRUSHING_STORM, // 483 ÀÌ±Û¾ÆÀÌ 2
		EFFECT_CLASS_STORM_CRUSHING, // 483 ÀÌ±Û¾ÆÀÌ 2
		EFFECT_CLASS_SKILL_SATELLITE_BOMB_AIM2,		  // ÎÀÐÇºä»÷ Ð§¹û¶¨Òå (ÈËÀà) 468
		EFFECT_CLASS_SKILL_SATELLITE_BOMB_POINT2,      // ÎÀÐÇºä»÷ Ð§¹û¶¨Òå (ÈËÀà)469
		EFFECT_CLASS_SKILL_SATELLITE_BOMB_FIRE2,          // ¿ªÇ¹Ð§¹û470
		EFFECT_CLASS_INTIMATE_GRAIL2,				// 439
		EFFECT_CLASS_HOLY_ARMOR2,						// 284
		EFFECT_CLASS_BLESS2,					   // 5
		EFFECT_CLASS_STRIKING2,					// 6
		EFFECT_CLASS_GLORYGROUND,					// 6
		EFFECT_CLASS_PASSING_HEAL2,					// 448
		EFFECT_CLASS_BLOODY_SKULL,
		EFFECT_CLASS_SKULL_BLOODY,
		EFFECT_CLASS_RAGE_OF_BLOOD,
		EFFECT_CLASS_CHAIN_OF_DEMON,
		EFFECT_CLASS_CHAIN_OF_DEMON_BACK,
		EFFECT_CLASS_ALLYSTER_WIND,
		EFFECT_CLASS_FLAME_SIGHT,
		EFFECT_CLASS_LIFE_AQUA_OF_RADCHIA,
/*
½ºÅ©·Ñ °ü·Ã ºÎºÐ.
¾Æ·¡ ½ºÅ©·ÑµéÀº Á¢¼Ó Á¾·á?Ï¸?½Ã°£ÀÌ Áö¼ÓÀûÀ¸·Î Áö³ª°¡¸ç, Á¢¼Ó Á¾·áÇÑ´Ù°í ÇÏ¿© ÀÌÆåÆ®°¡ »ç¶óÁöÁö ¾Ê´Â´Ù.
´Ù¸¸, Á¾·áÈÄ¿¡´Â ½Ã°£ÀÌ Áö¼ÓÀûÀ¸·Î ±îÁú»ÓÀÌ´Ù.
¹°·Ð... ½ºÅ©·Ñ¿¡ ´ëÇÑ ÀÌÆåÆ® ±¸Á¶¹®À» Â¥Áà¾ß°ÚÁö..¤µ¤²..
*/
		EFFECT_CLASS_BEHMOTH_FORCE_SCROLL,
		EFFECT_CLASS_SAFE_FORCE_SCROLL,
		EFFECT_CLASS_CANELIAN_FORCE_SCROLL,
		EFFECT_CLASS_FURIOUS_INCENSE,
		EFFECT_CLASS_STRENGTHEN_INCENSE,
		EFFECT_CLASS_HYPERACTIVE_INCENSE,
		EFFECT_CLASS_IMPREGNABLE_INCENSE,
		EFFECT_CLASS_GREYFELL_FORCE_SCROLL,
		EFFECT_CLASS_SOVIUS_FORCE_SCROLL,
		EFFECT_CLASS_MIR_FORCE_SCROLL,
		EFFECT_CLASS_ODIN_FORCE_SCROLL,
		EFFECT_CLASS_TITUOS_FORCE_SCROLL,
		EFFECT_CLASS_ORDINIS_VAPOR_RED,
		EFFECT_CLASS_ORDINIS_VAPOR_BLUE,
		EFFECT_CLASS_PET_EXP1,
		EFFECT_CLASS_EXP_BOUNS_STONE,
		EFFECT_CLASS_EXTREAME_FORCE_SCROLL,
		EFFECT_CLASS_ADVANCED_EXP_BONUS,
		EFFECT_CLASS_ACCURA_FORCE_SCROLL,
		EFFECT_CLASS_LIFE_FORCE_SCROLL,
		EFFECT_CLASS_CHAOS_EXP_STONE,
		EFFECT_CLASS_SEVEN_FOLD_STONE,
/*
¸ó½ºÅÍ ÀÌÆåÆ® °ü·Ã
¸ó½ºÅÍ°¡ ¸®Á¨½Ã ºÙ´Â ÀÌÆåÆ®·Î »õ·Î¿î »ç¿ëÀÚ³ª ±âÁ¸ »ç¿ëÀÚ¿¡°Ô ¸®Á¨½Ã º¼¼ö ÀÖ´Ù.
*/
		EFFECT_CLASS_MONSTER_MASTER_EFFECT1,
		EFFECT_CLASS_MONSTER_MASTER_EFFECT2,
		EFFECT_CLASS_MONSTER_MASTER_EFFECT3,
		EFFECT_CLASS_MONSTER_MASTER_EFFECT4,
		EFFECT_CLASS_MONSTER_MASTER_EFFECT5,
		EFFECT_CLASS_MONSTER_MASTER_EFFECT6,
		EFFECT_CLASS_MONSTER_HEAL,
		EFFECT_CLASS_SIMYUN_ENTER_LOOP, //  ½É¿¬ÀÇ °Å¿ï ÀÔÀå Á¦ÇÑ
		EFFECT_CLASS_MONSTER_TILE_STORM,				// 150
		EFFECT_CLASS_SHINE_SWORD,

	EFFECT_CLASS_SUMMON_WISP_RED,				// 539
	EFFECT_CLASS_SUMMON_WISP_YELLOW,			// 540
	EFFECT_CLASS_SUMMON_WISP_GREEN,				// 541

	EFFECT_CLASS_CLIENT_WING_SYLPH,							//26
	EFFECT_CLASS_CLIENT_UNICORN,							//28
	...
	EFFECT_CLASS_ATTACK_BLOOD_BURST,
	EFFECT_CLASS_DEFENSE_BLOOD_BURST,
	EFFECT_CLASS_PARTY_BLOOD_BURST,

	EFFECT_CLASS_DEADLY_GLAND,
	EFFECT_CLASS_SUDEEN_BLAST,
	EFFECT_CLASS_CYCLING_WAR_ROCK,
	EFFECT_CLASS_METEO_BLAZE,
	EFFECT_CLASS_METEO_BLAZE_TO_CREATURE,
	EFFECT_CLASS_TORRENTIALLIFE,

	EFFECT_CLASS_MAGMATIC_EUPTION,
	EFFECT_CLASS_LIGHTING_SHOCK,
	EFFECT_CLASS_VIA_CRUCIS,
	EFFECT_CLASS_SOLA_FLARE,
	EFFECT_CLASS_LIGHTING_SHOCK_USER,

	EFFECT_CLASS_CHAKRAM_HAIL,
	EFFECT_CLASS_LOGIN_EVENT,
	EFFECT_CLASS_HELL_GARDEN_JOIN,
	EFFECT_CLASS_MENEGROS,
	EFFECT_CLASS_CASTLE_OF_DENSE,
	EFFECT_CLASS_STUN,
	EFFECT_CLASS_EXP_TIME,
	EFFECT_CLASS_HI_PASS,
	EFFECT_CLASS_TRANSLUCENCY,	//¸ó½ºÅÍ ¹ÝÅõ¸í ½ºÅ³ (½ºÅ³ ¾×¼ÇÀº Ãß°¡ µÇÁö ¾Ê´Â´Ù. ID¿Í Å©¸®ÃÄ Object °ªÀ¸·Î ¹ÝÅõ¸í Ã³¸® ÇÑ´Ù.)
	EFFECT_CLASS_TIFFAUGES_REALWORLD_LEFT_UP,
	EFFECT_CLASS_TIFFAUGES_REALWORLD_RIGHT_UP,
	EFFECT_CLASS_TIFFAUGES_OTHERWORLD_LEFT_UP,
	EFFECT_CLASS_TIFFAUGES_OTHERWORLD_RIGHT_UP,
	EFFECT_CLASS_RING_OF_FLARE_UPGRADE,						// 238
	EFFECT_CLASS_VICIOUS_GUIDANCE,
	EFFECT_CLASS_DRAGON_HURRICANE,
	EFFECT_CLASS_BLIZZARD,
	EFFECT_CLASS_SHADY_DOUPLE,
	EFFECT_CLASS_THE_RAGE_OF_GUARDIAN_SPIRIT,
	EFFECT_CLASS_TRUE_COLOR_OF_VAMP_LOAD,
	EFFECT_CLASS_THE_ROAR_OF_AWAKEN_WARRIOR,
	EFFECT_CLASS_TIFFAUGES_OLD_JOIN,
	EFFECT_CLASS_MOLE_SHOT,
	        EFFECT_CLASS_MAX
	};
...
public:
	...
	virtual void unaffect(Creature* pCreature) throw(Error) { throw UnsupportedError(__PRETTY_FUNCTION__); } // ¿ø·¡´Â pure virtualÀÌ¾ú´Âµ¥ EffectRelicTable¶§¸Þ ¹Ù²å´Ù. by sigi
