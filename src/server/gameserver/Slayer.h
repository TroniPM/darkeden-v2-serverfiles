...
public:
    ...
    //////////////////////////////////////////////////////////////
public:
    virtual CreatureClass getCreatureClass()
    {
        return CREATURE_CLASS_SLAYER;
    }
    virtual string getCreatureClassString()
    {
        return "CREATURE_CLASS_SLAYER";
    }
...
public:
    ...
    virtual Color_t getShopColor()
    {
        return m_ShopColor;
    }
    virtual void setShopColor(Color_t ShopColor)
    {
        m_ShopColor = ShopColor;
    }

    virtual ItemType_t getJacketItemType()
    {
        return m_JacketItemType;
    }
    virtual void setJacketItemType(ItemType_t ItemType)
    {
        m_JacketItemType = ItemType;
    }
...
public:
    ...
    Attr_t	getTotalAttr( AttrType attrType = ATTR_CURRENT )
    {
...
public:
    ...
    //////////////////////////////////////////////////////////////
public:
    Damage_t     getDamage(AttrType attrType = ATTR_CURRENT)
    {
        return m_Damage[attrType];
    }
    Protection_t getProtection(void)
    {
        return m_Protection[ATTR_CURRENT];
    }
    Defense_t    getDefense(void)
    {
        return m_Defense[ATTR_CURRENT];
    }
    ToHit_t      getToHit(void)
    {
        return m_ToHit[ATTR_CURRENT];
    }
    Speed_t      getAttackSpeed(void)
    {
    ...
    //////////////////////////////////////////////////////////////
public:
    Exp_t getGoalExp(SkillDomainType_t Domain)
    {
    ...
    SkillLevel_t getSkillDomainLevel(SkillDomainType_t skillDomain)
    {
...
public:
    ...
    virtual Item *findSubInventoryID(ItemID_t id)
    {
        return ::findItemIID(this, id, Item::ITEM_CLASS_SUB_INVENTORY);
    }
    virtual Item *findSubInventoryID(ItemID_t id, int &storage, int &x, int &y)
    {
        return ::findItemIID(this, id, Item::ITEM_CLASS_SUB_INVENTORY, storage, x, y);
    }
...
public:
    ...
    virtual Fame_t getKillPoint()
    {
        return m_KillPoint;
    }
    virtual void   setKillPoint(Fame_t Kill)
    {
        m_KillPoint = Kill;
    }

    virtual Gold_t getGold()
    {
        return m_Gold;
    }
    ...
    virtual Attr_t getAttackBloodBurstPoint() const
    {
        return m_AttackBloodBurstPoint;
    }
    virtual void setAttackBloodBurstPoint( Attr_t point )
    {
        m_AttackBloodBurstPoint = point;
    }

    virtual Attr_t getDefenseBloodBurstPoint() const
    {
        return m_DefenseBloodBurstPoint;
    }
    virtual void setDefenseBloodBurstPoint( Attr_t point )
    {
        m_DefenseBloodBurstPoint = point;
    }

    virtual Attr_t getPartyBloodBurstPoint() const
    {
        return m_PartyBloodBurstPoint;
    }
    virtual void setPartyBloodBurstPoin( Attr_t point )
    {
    ...
    virtual ZoneID_t getResurrectZoneID(void)
    {
