...
class VampireCoat : public ConcreteItem<Item::ITEM_CLASS_VAMPIRE_COAT, NoStack, HasDurability, HasOption, ClothGrade, NoAttacking,  NoEnchantLevel, HasOption2, HasHeroOption, HasHeroOptionAttr>
{
public:
	VampireCoat() ;
...
public:
//	virtual ItemClass getItemClass()  { return Item::ITEM_CLASS_VAMPIRE_COAT; }
//	virtual string getObjectTableName()  { return "VampireCoatObject"; }
...
{
public:
	virtual Item::ItemClass getItemClass()  { return Item::ITEM_CLASS_VAMPIRE_COAT; }
...
public:
	virtual Item::ItemClass getItemClass()  { return Item::ITEM_CLASS_VAMPIRE_COAT; }
	virtual string getItemClassName()  { return "VampireCoat"; }
	
public:
	virtual Item* createItem(ItemType_t ItemType, const list<OptionType_t>& OptionType)  { return new VampireCoat(ItemType,OptionType); }
};
