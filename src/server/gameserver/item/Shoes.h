...
class Shoes : public ConcreteItem<Item::ITEM_CLASS_SHOES, NoStack, HasDurability, HasOption, GroceryGrade, NoAttacking, NoEnchantLevel, HasOption2, HasHeroOption, HasHeroOptionAttr>
{
public:
	Shoes() throw();
...
public:
//	virtual ItemClass getItemClass()  { return Item::ITEM_CLASS_SHOES; }
//	virtual string getObjectTableName()  { return "ShoesObject"; }
...
{
public:
	virtual Item::ItemClass getItemClass()  { return Item::ITEM_CLASS_SHOES; }
...
public:
	virtual Item::ItemClass getItemClass()  { return Item::ITEM_CLASS_SHOES; }
	virtual string getItemClassName()  { return "Shoes"; }
