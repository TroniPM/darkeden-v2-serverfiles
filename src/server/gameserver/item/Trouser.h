...
class Trouser : public ConcreteItem<Item::ITEM_CLASS_TROUSER, NoStack, HasDurability, HasOption, ClothGrade, NoAttacking, NoEnchantLevel, HasOption2, HasHeroOption, HasHeroOptionAttr>
{
public:
	Trouser() ;
...
public:
//	virtual ItemClass getItemClass()  { return Item::ITEM_CLASS_TROUSER; }
//	virtual string getObjectTableName()  { return "TrouserObject"; }
...
{
public:
	virtual Item::ItemClass getItemClass()  { return Item::ITEM_CLASS_TROUSER; }
...
public:
	virtual Item::ItemClass getItemClass()  { return Item::ITEM_CLASS_TROUSER; }
	virtual string getItemClassName()  { return "Trouser"; }
	
public:
	virtual Item* createItem(ItemType_t ItemType, const list<OptionType_t>& OptionType)  { return new Trouser(ItemType,OptionType); }
};
