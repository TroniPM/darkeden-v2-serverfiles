...
public:
//	virtual ItemClass getItemClass() const throw() { return Item::ITEM_CLASS_VAMPIRE_BRACELET; }
//	virtual string getObjectTableName() const throw() { return "VampireBraceletObject"; }
...
{
public:
	virtual Item::ItemClass getItemClass() const throw() { return Item::ITEM_CLASS_VAMPIRE_BRACELET; }
...
public:
	virtual Item::ItemClass getItemClass() const throw() { return Item::ITEM_CLASS_VAMPIRE_BRACELET; }
	virtual string getItemClassName() const throw() { return "VampireBracelet"; }
