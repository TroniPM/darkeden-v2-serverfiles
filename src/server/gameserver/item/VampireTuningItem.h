...
public:
	VampireTuningItem() ;
	VampireTuningItem(ItemType_t itemType, const list<OptionType_t>& optionType, ItemNum_t Num) ;
...
public:
	virtual Item* createItem(ItemType_t ItemType, const list<OptionType_t>& OptionType)  { return new VampireTuningItem(ItemType,OptionType,1); }
};
