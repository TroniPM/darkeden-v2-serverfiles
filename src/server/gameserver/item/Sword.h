...
class Sword : public ConcreteItem<Item::ITEM_CLASS_SWORD, NoStack, HasDurability, HasOption, WeaponGrade, SlayerWeapon,   NoEnchantLevel, HasOption2, HasHeroOption, HasHeroOptionAttr>
{
public:
	Sword() throw();
...
public:
//	virtual ItemClass getItemClass()  { return Item::ITEM_CLASS_SWORD; }
//	virtual string getObjectTableName()  { return "SwordObject"; }
...
{
public:
	virtual Item::ItemClass getItemClass()  { return Item::ITEM_CLASS_SWORD; }
...
public:
	virtual Item::ItemClass getItemClass()  { return Item::ITEM_CLASS_SWORD; }
	virtual string getItemClassName()  { return "Sword"; }
