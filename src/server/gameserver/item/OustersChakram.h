...
//	virtual string getObjectTableName()  { return "OustersChakramObject"; }
...
{
public:
	virtual Item::ItemClass getItemClass()  { return Item::ITEM_CLASS_OUSTERS_CHAKRAM; }
...
public:
	virtual Item::ItemClass getItemClass()  { return Item::ITEM_CLASS_OUSTERS_CHAKRAM; }
	virtual string getItemClassName()  { return "OustersChakram"; }
