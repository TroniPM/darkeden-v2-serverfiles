...
public:
//	virtual ItemClass getItemClass() const throw() { return Item::ITEM_CLASS_MACE; }
//	virtual string getObjectTableName() const throw() { return "MaceObject"; }
...
{
public:
	virtual Item::ItemClass getItemClass() const throw() { return Item::ITEM_CLASS_MACE; }
...
public:
	virtual Item::ItemClass getItemClass() const throw() { return Item::ITEM_CLASS_MACE; }
	virtual string getItemClassName() const throw() { return "Mace"; }
