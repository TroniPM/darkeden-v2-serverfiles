...
class Coat : public ConcreteItem<Item::ITEM_CLASS_COAT, NoStack, HasDurability, HasOption, ClothGrade, NoAttacking, HasEnchantLevel,HasOption2, HasHeroOption, HasHeroOptionAttr>
{
public:
	Coat() ;
...
public:
//	virtual ItemClass getItemClass()  { return Item::ITEM_CLASS_COAT; }
//	virtual string getObjectTableName()  { return "CoatObject"; }
...
{
public:
	virtual Item::ItemClass getItemClass()  { return Item::ITEM_CLASS_COAT; }
...
public:
	virtual Item::ItemClass getItemClass()  { return Item::ITEM_CLASS_COAT; }
	virtual string getItemClassName()  { return "Coat"; }
	
public:
	virtual Item* createItem(ItemType_t ItemType, const list<OptionType_t>& OptionType)  { return new Coat(ItemType,OptionType); }
