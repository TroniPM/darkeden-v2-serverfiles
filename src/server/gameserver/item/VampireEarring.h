...
class VampireEarring : public ConcreteItem<Item::ITEM_CLASS_VAMPIRE_EARRING, NoStack, HasDurability, HasOption, AccessoryGrade, NoAttacking,   NoEnchantLevel, HasOption2, HasHeroOption, HasHeroOptionAttr>
{
public:
	VampireEarring() throw();
	VampireEarring(ItemType_t itemType, const list<OptionType_t>& optionType) throw();
...
public:
//	virtual ItemClass getItemClass() const throw() { return Item::ITEM_CLASS_VAMPIRE_EARRING; }
//	virtual string getObjectTableName() const throw() { return "VampireEarringObject"; }
...
{
public:
	virtual Item::ItemClass getItemClass() const throw() { return Item::ITEM_CLASS_VAMPIRE_EARRING; }
...
public:
	virtual Item::ItemClass getItemClass() const throw() { return Item::ITEM_CLASS_VAMPIRE_EARRING; }
	virtual string getItemClassName() const throw() { return "VampireEarring"; }
	
public:
	virtual Item* createItem(ItemType_t ItemType, const list<OptionType_t>& OptionType) throw() { return new VampireEarring(ItemType,OptionType); }
};
