...
ITEMIDREGISTRY(EtheReal,"EtheRealObject");
ITEMIDREGISTRY(SkillBook,"SkillBookObject");
ITEMIDREGISTRY(StoneAbility,"StoneAbilityObject");
ITEMIDREGISTRY(NecklaceZap,"NecklaceZapObject");
ITEMIDREGISTRY(CoatZap,"CoatZapObject");
ITEMIDREGISTRY(BootZap,"BootZapObject");
ITEMIDREGISTRY(WeaponZap,"WeaponZapObject");
ITEMIDREGISTRY(HelmZap,"HelmZapObject");
ITEMIDREGISTRY(GloveZap,"GloveZapObject");
ITEMIDREGISTRY(BeltZap,"BeltZapObject");
ITEMIDREGISTRY(ShoesZap,"ShoesZapObject");
ITEMIDREGISTRY(CommonItem,"CommonItemObject");
ITEMIDREGISTRY(SlayerTuningItem,"SlayerTuningItemObject");
ITEMIDREGISTRY(VampireWingItem,"VampireWingItemObject");
ITEMIDREGISTRY(OustersWingItem,"OustersWingItemObject");
