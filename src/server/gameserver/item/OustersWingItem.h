...
public:
	OustersWingItem() ;
	OustersWingItem(ItemType_t itemType, const list<OptionType_t>& optionType) ;
...
public:
	virtual Item* createItem(ItemType_t ItemType, const list<OptionType_t>& OptionType)  { return new OustersWingItem(ItemType,OptionType); }
};
