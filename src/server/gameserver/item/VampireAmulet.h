...
class VampireAmulet : public ConcreteItem<Item::ITEM_CLASS_VAMPIRE_AMULET, NoStack, NoDurability, HasOption, AccessoryGrade, NoAttacking,  NoEnchantLevel, HasOption2, HasHeroOption, HasHeroOptionAttr>
{
public:
	VampireAmulet() throw();
	VampireAmulet(ItemType_t itemType, const list<OptionType_t>& optionType) throw();
...
public:
//	virtual ItemClass getItemClass() const throw() { return Item::ITEM_CLASS_VAMPIRE_AMULET; }
//	virtual string getObjectTableName() const throw() { return "VampireAmuletObject"; }
...
{
public:
	virtual Item::ItemClass getItemClass() const throw() { return Item::ITEM_CLASS_VAMPIRE_AMULET; }
...
public:
	virtual Item::ItemClass getItemClass() const throw() { return Item::ITEM_CLASS_VAMPIRE_AMULET; }
	virtual string getItemClassName() const throw() { return "VampireAmulet"; }
	
public:
	virtual Item* createItem(ItemType_t ItemType, const list<OptionType_t>& OptionType) throw() { return new VampireAmulet(ItemType,OptionType); }
};
