...
class OustersCoat : public ConcreteItem<Item::ITEM_CLASS_OUSTERS_COAT, NoStack, HasDurability, HasOption, ClothGrade, NoAttacking, NoEnchantLevel, HasOption2, HasHeroOption, HasHeroOptionAttr>
{
public:
	OustersCoat() ;
...
public:
//	virtual ItemClass getItemClass()  { return Item::ITEM_CLASS_OUSTERS_COAT; }
//	virtual string getObjectTableName()  { return "OustersCoatObject"; }
...
{
public:
	virtual Item::ItemClass getItemClass()  { return Item::ITEM_CLASS_OUSTERS_COAT; }
...
public:
	virtual Item::ItemClass getItemClass()  { return Item::ITEM_CLASS_OUSTERS_COAT; }
	virtual string getItemClassName()  { return "OustersCoat"; }

public:
	virtual Item* createItem(ItemType_t ItemType, const list<OptionType_t>& OptionType)  { return new OustersCoat(ItemType,OptionType); }
};
