...
public:
	virtual ItemClass getItemClass() const throw() { return Item::ITEM_CLASS_OUSTERS_TUNING_ITEM; }
	virtual string getObjectTableName() const throw() { return "OustersTuningItemObject"; }
...
{
public:
	virtual Item::ItemClass getItemClass() const throw() { return Item::ITEM_CLASS_OUSTERS_TUNING_ITEM; }
	virtual string toString() const throw();
...
public:
	virtual Item::ItemClass getItemClass() const throw() { return Item::ITEM_CLASS_OUSTERS_TUNING_ITEM; }
	virtual string getItemClassName() const throw() { return "OustersTuningItem"; }
