...
public:
//	virtual ItemClass getItemClass()  { return Item::ITEM_CLASS_OUSTERS_CIRCLET; }
//	virtual string getObjectTableName()  { return "OustersCircletObject"; }
...
{
public:
	virtual Item::ItemClass getItemClass()  { return Item::ITEM_CLASS_OUSTERS_CIRCLET; }
...
public:
	virtual Item::ItemClass getItemClass()  { return Item::ITEM_CLASS_OUSTERS_CIRCLET; }
	virtual string getItemClassName()  { return "OustersCirclet"; }

public:
	virtual Item* createItem(ItemType_t ItemType, const list<OptionType_t>& OptionType)  { return new OustersCirclet(ItemType,OptionType); }
};
