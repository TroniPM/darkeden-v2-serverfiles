...
public:
	virtual ItemClass getItemClass() const throw() { return Item::ITEM_CLASS_VAMPIREWING_ITEM; }
...
{
public:
	virtual Item::ItemClass getItemClass() const throw() { return Item::ITEM_CLASS_VAMPIREWING_ITEM; }
	virtual string toString() const throw();
};
