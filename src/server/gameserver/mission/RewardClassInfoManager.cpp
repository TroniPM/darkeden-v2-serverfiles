...
QuestMessage RewardClassInfoManager::canGiveReward( RewardClass_t rClass, PlayerCreature* pPC ) 
{
	__BEGIN_TRY
...
RewardClass* RewardClassInfoManager::getRewardClass( RewardClass_t rClass ) 
{
	__BEGIN_TRY
