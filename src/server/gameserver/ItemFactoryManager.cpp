	 ...
	 throw (Error)
{
	...
	m_Factories[Item::ITEM_CLASS_ETHEREAL] = new EtheRealFactory();
	m_ItemClassMap[m_Factories[Item::ITEM_CLASS_ETHEREAL]->getItemClassName()] = Item::ITEM_CLASS_ETHEREAL;

	m_Factories[Item::ITEM_CLASS_SKILLBOOK] = new SkillBookFactory();
	m_ItemClassMap[m_Factories[Item::ITEM_CLASS_SKILLBOOK]->getItemClassName()] = Item::ITEM_CLASS_SKILLBOOK;

	m_Factories[Item::ITEM_CLASS_STONE_ABILITY] = new StoneAbilityFactory();
	m_ItemClassMap[m_Factories[Item::ITEM_CLASS_STONE_ABILITY]->getItemClassName()] = Item::ITEM_CLASS_STONE_ABILITY;

	m_Factories[Item::ITEM_CLASS_NECKLACEZAP] = new NecklaceZapFactory();
	m_ItemClassMap[m_Factories[Item::ITEM_CLASS_NECKLACEZAP]->getItemClassName()] = Item::ITEM_CLASS_NECKLACEZAP;

	m_Factories[Item::ITEM_CLASS_COATZAP] = new CoatZapFactory();
	m_ItemClassMap[m_Factories[Item::ITEM_CLASS_COATZAP]->getItemClassName()] = Item::ITEM_CLASS_COATZAP;

	m_Factories[Item::ITEM_CLASS_BOOTZAP] = new BootZapFactory();
	m_ItemClassMap[m_Factories[Item::ITEM_CLASS_BOOTZAP]->getItemClassName()] = Item::ITEM_CLASS_BOOTZAP;

	m_Factories[Item::ITEM_CLASS_WEAPONZAP] = new WeaponZapFactory();
	m_ItemClassMap[m_Factories[Item::ITEM_CLASS_WEAPONZAP]->getItemClassName()] = Item::ITEM_CLASS_WEAPONZAP;

	m_Factories[Item::ITEM_CLASS_HELMZAP] = new HelmZapFactory();
	m_ItemClassMap[m_Factories[Item::ITEM_CLASS_HELMZAP]->getItemClassName()] = Item::ITEM_CLASS_HELMZAP;

	m_Factories[Item::ITEM_CLASS_BELTZAP] = new BeltZapFactory();
	m_ItemClassMap[m_Factories[Item::ITEM_CLASS_BELTZAP]->getItemClassName()] = Item::ITEM_CLASS_BELTZAP;

	m_Factories[Item::ITEM_CLASS_GLOVEZAP] = new GloveZapFactory();
	m_ItemClassMap[m_Factories[Item::ITEM_CLASS_GLOVEZAP]->getItemClassName()] = Item::ITEM_CLASS_GLOVEZAP;

	m_Factories[Item::ITEM_CLASS_SHOESZAP] = new ShoesZapFactory();
	m_ItemClassMap[m_Factories[Item::ITEM_CLASS_SHOESZAP]->getItemClassName()] = Item::ITEM_CLASS_SHOESZAP;

	m_Factories[Item::ITEM_CLASS_COMMON_ITEM] = new CommonItemFactory();
	m_ItemClassMap[m_Factories[Item::ITEM_CLASS_COMMON_ITEM]->getItemClassName()] = Item::ITEM_CLASS_COMMON_ITEM;

	m_Factories[Item::ITEM_CLASS_SLAYER_TUNING_ITEM] = new SlayerTuningItemFactory();
	m_ItemClassMap[m_Factories[Item::ITEM_CLASS_SLAYER_TUNING_ITEM]->getItemClassName()] = Item::ITEM_CLASS_SLAYER_TUNING_ITEM;

	m_Factories[Item::ITEM_CLASS_VAMPIREWING_ITEM] = new VampireWingItemFactory();
	m_ItemClassMap[m_Factories[Item::ITEM_CLASS_VAMPIREWING_ITEM]->getItemClassName()] = Item::ITEM_CLASS_VAMPIREWING_ITEM;

	m_Factories[Item::ITEM_CLASS_OUSTERSWING_ITEM] = new OustersWingItemFactory();
	m_ItemClassMap[m_Factories[Item::ITEM_CLASS_OUSTERSWING_ITEM]->getItemClassName()] = Item::ITEM_CLASS_OUSTERSWING_ITEM;

	m_Factories[Item::ITEM_CLASS_VAMPIRE_TUNING_ITEM] = new VampireTuningItemFactory();
	m_ItemClassMap[m_Factories[Item::ITEM_CLASS_VAMPIRE_TUNING_ITEM]->getItemClassName()] = Item::ITEM_CLASS_VAMPIRE_TUNING_ITEM;

	m_Factories[Item::ITEM_CLASS_OUSTERS_TUNING_ITEM] = new OustersTuningItemFactory();
	m_ItemClassMap[m_Factories[Item::ITEM_CLASS_OUSTERS_TUNING_ITEM]->getItemClassName()] = Item::ITEM_CLASS_OUSTERS_TUNING_ITEM;
