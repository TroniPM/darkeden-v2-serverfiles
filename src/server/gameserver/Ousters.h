...
public:
    ...
    virtual BYTE getWingSylphType()
    {
        return m_WingSylphType;
    }
    virtual void setWingSylphType(BYTE Type)
    {
        m_WingSylphType = Type;
    }

    virtual ItemType_t getWingItemType()
    {
        return m_WingItemType;
    }
    virtual void setWingItemType(ItemType_t ItemType)
    {
        m_WingItemType = ItemType;
    }

    virtual Color_t getWingColor()
    {
        return m_WingColor;
    }
    virtual void	setWingColor(Color_t batColor)
    {
        m_WingColor = batColor;
    }

    virtual Color_t getWingEffectColor()
    {
        return m_WingEffectColor;
    }
    virtual void	setWingEffectColor(Color_t batColor)
    {
        m_WingEffectColor = batColor;
    }
...
public:
    ...
    OustersSkillSlot *hasSkill(SkillType_t SkillType)
    {
...
public:
    ...
    virtual void   setKillPoint(Fame_t KillPoint)
    {
