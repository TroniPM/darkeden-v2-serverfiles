	...
	
{
	...
	g_pMonsterItemDropManager		= new MonsterItemDropManager();
	g_pMonsterItemDropOptionManager		= new MonsterItemDropOptionManager();
	g_pMonsterDropSetupManager	=	new MonsterDropSetupManager();
	g_pInstantDungeonMonsterManager		= new InstantDungeonMonsterManager();
	g_pCrystalOptionLoaderManager		= new CrystalOptionLoaderManager();
	...
	
{
	...
	SAFE_DELETE(g_pMonsterDropSetupManager);
	SAFE_DELETE(g_pMonsterItemDropManager);
	SAFE_DELETE(g_pMonsterItemDropOptionManager);
	SAFE_DELETE(g_pInstantDungeonMonsterManager);
	SAFE_DELETE(g_pCrystalOptionLoaderManager);
	 ...
	 
{
	...
	printf("ObjectManager::init() : MonsterItemDropManager Initialization Start\n");
	g_pMonsterItemDropManager->load();
	printf("ObjectManager::init() : MonsterItemDropManager Initialization Success\n");

	printf("ObjectManager::init() : MonsterDropSetupManager Initialization Start\n");
	g_pMonsterDropSetupManager->load();
	printf("ObjectManager::init() : MonsterDropSetupManager Initialization Success\n");

	printf("ObjectManager::init() : MonsterItemDropOptionManager Initialization Start\n");
	g_pMonsterItemDropOptionManager->load();
	printf("ObjectManager::init() : MonsterItemDropOptionManager Initialization Success\n");

	printf("ObjectManager::init() : InstantDungeonMonsterManager Initialization Start\n");
	g_pInstantDungeonMonsterManager->load();
	printf("ObjectManager::init() : InstantDungeonMonsterManager Initialization Success\n");

	printf("ObjectManager::init() : CrystalOptionLoaderManager Initialization Start\n");
	g_pCrystalOptionLoaderManager->load();
	printf("ObjectManager::init() : CrystalOptionLoaderManager Initialization Success\n");
...
//	printf("ObjectManager::load() : FameLimitInfoManager Initialization Success\n");
	...
	printf("ObjectManager::load() : ItemHeroOptionManager Initialization Start\n");
	ItemHeroOptionManager::Instance().load();
	printf("ObjectManager::load() : ItemHeroOptionManager Initialization Success\n");
