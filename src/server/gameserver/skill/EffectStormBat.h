...
#ifndef __EFFECT_STORM_BAT__
#define __EFFECT_STORM_BAT__
...
class EffectStormBat : public Effect 
{
public:
	EffectStormBat(Creature* pCreature) throw(Error);

public:
    EffectClass getEffectClass() const throw() { return EFFECT_CLASS_STORM_BAT; }
