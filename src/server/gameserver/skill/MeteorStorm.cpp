...
void MeteorStorm::execute(Ousters* pOusters, ZoneCoord_t X, ZoneCoord_t Y, OustersSkillSlot* pOustersSkillSlot, CEffectID_t CEffectID) throw(Error)
{
	__BEGIN_TRY
...
void MeteorStorm::execute(Monster* pMonster, Creature* pEnemy) throw(Error)
{
	__BEGIN_TRY
