...
// 뱀파이어 오브젝트 핸들러
//////////////////////////////////////////////////////////////////////////////
void Manticoret::execute(Vampire* pVampire, ObjectID_t TargetObjectID, VampireSkillSlot* pVampireSkillSlot, CEffectID_t CEffectID)
	throw(Error)
{
	__BEGIN_TRY
...
// 몬스터 오브젝트 핸들러
//////////////////////////////////////////////////////////////////////////////
void Manticoret::execute(Monster* pMonster, Creature* pEnemy)
	throw(Error)
{
	__BEGIN_TRY
	...
	if (0)//pMonster->isMaster())
	{
		...
		for (; itr != creatureList.end(); itr++)
		{
			...
			{
				cout << "Master's Manticoret: " << i << endl;
				i++;
