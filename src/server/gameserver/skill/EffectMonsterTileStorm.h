...
{
public:
	EffectMonsterTileStorm(Zone* pZone, ZoneCoord_t zoneX, ZoneCoord_t zoneY) throw(Error);

public:
    EffectClass getEffectClass() const throw() { return EFFECT_CLASS_MONSTER_TILE_STORM; }
...
{
public:
	virtual Effect::EffectClass getEffectClass() const throw() { return Effect::EFFECT_CLASS_MONSTER_TILE_STORM; }
	virtual string getEffectClassName() const throw() { return "EffectMonsterTileStorm"; }
