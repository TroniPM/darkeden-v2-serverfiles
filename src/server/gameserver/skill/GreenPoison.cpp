	...
	throw(Error)
{
	...
	cout << " 그린 포이즌 사용 7 " << endl;
			...
			cout << " 그린 포이즌 사용 8 " << endl;
			list<Creature*> cList;
			cList.push_back(pMonster);
			if (bEffected) cList.push_back(pTargetCreature);
	cout << " 그린 포이즌 사용 9 " << endl;
			cList = pZone->broadcastSkillPacket(myX, myY, X, Y, &_GCSkillToTileOK5, cList);
