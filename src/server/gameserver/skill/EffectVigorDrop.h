...
public:
	...
	EffectClass getEffectClass()  { return EFFECT_CLASS_VIGOR_DROP; }
...
{
public:
	virtual Effect::EffectClass getEffectClass()  { return Effect::EFFECT_CLASS_VIGOR_DROP; }
	virtual string getEffectClassName()  { return "EffectVigorDrop"; }
