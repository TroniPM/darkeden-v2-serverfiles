...
//////////////////////////////////////////////////////////////////////////////
//////////////////////////////////////////////////////////////////////////////
EffectDragonHurricane::EffectDragonHurricane(Zone* pZone, ZoneCoord_t zoneX, ZoneCoord_t zoneY) 
	throw(Error)
{
	__BEGIN_TRY
...
//////////////////////////////////////////////////////////////////////////////
//////////////////////////////////////////////////////////////////////////////
void EffectDragonHurricane::affect()
	throw(Error)
{
	__BEGIN_TRY
	...
	else
	{
		...
		if ( isValidZoneCoord( m_pZone, newX, newY ) && m_pZone->getTile(newX, newY).canAddEffect() )
		{
			EffectDragonHurricane* pEffect = new EffectDragonHurricane( m_pZone, newX, newY );
...
//////////////////////////////////////////////////////////////////////////////
//////////////////////////////////////////////////////////////////////////////
void EffectDragonHurricane::affect(Creature* pCreature)
	throw(Error)
{
	__BEGIN_TRY
	...
	if (pCreature->isSlayer()) 
	{
		...
		::setDamage( pSlayer, m_Damage, pCastCreature, SKILL_DRAGON_HURRICANE, &gcSkillToObjectOK6, &gcAttackerMI);
...
/*						Player* pPlayer = pSlayer->getPlayer();
	...
	else if (pCreature->isVampire())
	{
		...
		::setDamage( pVampire, m_Damage, pCastCreature, SKILL_DRAGON_HURRICANE, &gcSkillToObjectOK6, &gcAttackerMI );
...
/*						Player* pPlayer = pVampire->getPlayer();
	...
	else if (pCreature->isOusters())
	{
		...
		::setDamage( pOusters, m_Damage, pCastCreature, SKILL_DRAGON_HURRICANE, &gcSkillToObjectOK6, &gcAttackerMI );
...
/*						Player* pPlayer = pOusters->getPlayer();
	...
	else if (pCreature->isMonster())
	{
		...
		::setDamage( pMonster, m_Damage, pCastCreature, SKILL_DRAGON_HURRICANE, NULL, &gcAttackerMI );
	...
	SkillType_t skillType = (isStun)?SKILL_DRAGON_HURRICANE:SKILL_ATTACK_MELEE;
...
//////////////////////////////////////////////////////////////////////////////
//////////////////////////////////////////////////////////////////////////////
void EffectDragonHurricane::unaffect(Creature* pCreature)
	throw(Error)
{
	__BEGIN_TRY
	__END_CATCH
...
//////////////////////////////////////////////////////////////////////////////
//////////////////////////////////////////////////////////////////////////////
void EffectDragonHurricane::unaffect()
	throw(Error)
{
	__BEGIN_TRY
...
//////////////////////////////////////////////////////////////////////////////
//////////////////////////////////////////////////////////////////////////////
string EffectDragonHurricane::toString()
	const throw()
{
	__BEGIN_TRY
