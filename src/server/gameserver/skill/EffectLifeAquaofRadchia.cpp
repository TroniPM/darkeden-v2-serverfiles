...
//////////////////////////////////////////////////////////////////////////////
//////////////////////////////////////////////////////////////////////////////
EffectLifeAquaofRadchia::EffectLifeAquaofRadchia(Zone* pZone, ZoneCoord_t zoneX, ZoneCoord_t zoneY) 
...
//////////////////////////////////////////////////////////////////////////////
//////////////////////////////////////////////////////////////////////////////
void EffectLifeAquaofRadchia::affect()
    ...
    for (; itr != oList.end(); itr++) 
	{
    	...
    	if (pObject->getObjectClass() == Object::OBJECT_CLASS_CREATURE)
		{
			...
			if (pCreature->getMoveMode() != Creature::MOVE_MODE_FLYING)
			{
				...
				gcAE.setEffectID( Effect::EFFECT_CLASS_LIFE_AQUA_OF_RADCHIA );
				gcAE.setDuration( 0 );
...
//////////////////////////////////////////////////////////////////////////////
//////////////////////////////////////////////////////////////////////////////
void EffectLifeAquaofRadchia::affect(Creature* pCreature)
...
//////////////////////////////////////////////////////////////////////////////
//////////////////////////////////////////////////////////////////////////////
void EffectLifeAquaofRadchia::unaffect(Creature* pCreature)
...
//////////////////////////////////////////////////////////////////////////////
//////////////////////////////////////////////////////////////////////////////
void EffectLifeAquaofRadchia::unaffect()
...
//////////////////////////////////////////////////////////////////////////////
//////////////////////////////////////////////////////////////////////////////
string EffectLifeAquaofRadchia::toString()
