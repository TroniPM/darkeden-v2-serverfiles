...
public:
	...
	EffectClass getEffectClass() const throw() { return EFFECT_CLASS_BAT_STORM; }
...
{
public:
	virtual Effect::EffectClass getEffectClass() const throw() { return Effect::EFFECT_CLASS_BAT_STORM; }
	virtual string getEffectClassName() const throw() { return "EffectBatStorm"; }
