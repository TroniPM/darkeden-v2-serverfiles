...
// 아우스터즈 오브젝트 핸들러
//////////////////////////////////////////////////////////////////////////////
void FlameSpike::execute(Ousters* pOusters, ObjectID_t TargetObjectID, OustersSkillSlot* pOustersSkillSlot, CEffectID_t CEffectID)
    throw(Error)
{
    __BEGIN_TRY
...
// 아우스터즈 타일 핸들러
//////////////////////////////////////////////////////////////////////////////
void FlameSpike::execute(Ousters* pOusters, ZoneCoord_t tX, ZoneCoord_t tY, OustersSkillSlot* pOustersSkillSlot, CEffectID_t CEffectID)
	throw(Error)
{
	__BEGIN_TRY
	...
	try 
	{
		...
		if (bManaCheck && bTimeCheck && bRangeCheck && bHitRoll && bSatisfyRequire)
		{
			...
			_GCSkillToTileOK2.setSkillType( SKILL_FLAME_SPIKE );
			...
			for ( oX = (int)X - 1 ; oX <= (int)X + 2 ; ++oX )
			for ( oY = (int)Y - 1 ; oY <= (int)Y + 2 ; ++oY )
			{
				...
				for (; itr != oList.end(); itr++) 
				{
					...
					if (pObject->getObjectClass() == Object::OBJECT_CLASS_CREATURE)
					{
						...
						if ( pCreature->getObjectID() == pOusters->getObjectID()
							...
							|| !canHit( pOusters, pCreature, SKILL_FLAME_SPIKE, pOustersSkillSlot->getExpLevel() )
							)
						{
							continue;
						}
						...
						if (pCreature->getMoveMode() != Creature::MOVE_MODE_FLYING)
						{
							if (pCreature->isSlayer()) 
							{
								...
								::setDamage( pSlayer, Damage, pOusters, SKILL_FLAME_SPIKE, &_GCSkillToTileOK2, &_GCSkillToTileOK1 );
							...
							else if (pCreature->isVampire())
							{
								...
								::setDamage( pVampire, Damage, pOusters, SKILL_FLAME_SPIKE, &_GCSkillToTileOK2, &_GCSkillToTileOK1 );
							...
							else if (pCreature->isMonster())
							{
								...
								::setDamage( pMonster, Damage, pOusters, SKILL_FLAME_SPIKE, NULL, &_GCSkillToTileOK1 );
							}
