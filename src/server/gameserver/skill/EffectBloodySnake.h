...
public:
    EffectClass getEffectClass()  { return EFFECT_CLASS_BLOODY_SNAKE; }
...
{
public:
	virtual Effect::EffectClass getEffectClass()  { return Effect::EFFECT_CLASS_BLOODY_SNAKE; }
	virtual string getEffectClassName()  { return "EffectBloodySnake"; }
