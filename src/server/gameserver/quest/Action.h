...
public:
	...
	enum ActionTypes 
	{
		...
		ACTION_PC_GETITEM,	// 엔피시와 아이템을 교환한다.
		ACTION_ENTER_INSTANT,	// 인스턴트 던전을 입장한다.
		ACTION_CREATE_GETITEM,	// 그냥 아이템을 생성한다.
		ACTION_DELETE_GETITEM,	// 그냥 아이템을 삭제한다.
		ACTION_CREATE_GETGOLD,	// 돈을 생성한다.
		ACTION_DELETE_GETGOLD,	// 돈을 삭제한다.
		ACTION_CREATE_GETITEM_RAND,	// 그냥 아이템을 생성한다.
		ACTION_HEIGHT_TEACH_SKILL,              // 플레이어에게 기술을 가르쳐준다.
		ACTION_SUMMON_MONSTER,              // 몬스터를 소환한다. 
		ACTION_ENTER_INSTANT_EXIT,
		ACTION_CREATE_EFFECT,	// 이펙트를 부여한다.
		ACTION_CREATE_EFFECT_NOTLOGOUT,	// 이펙트를 부여한다.
		ACTION_ORIGINAL_CREATE_GETITEM,	// 그냥 원본서 교환을 위한 아이템을 생성한다.
		ACTION_ORIGINAL_DELETE_GETITEM,	// 그냥 원본서 교환을 위한 아이템을 삭제한다.
		ACTION_ORIGINAL_DELETE_GETGOLD,	// 돈을 삭제한다.
		ACTION_MAX
	};
