...
{
public:
	virtual ActionType_t getActionType()  { return Action::ACTION_REGEN_EVENT_SHOP; }
	virtual string getActionName()  { return "RegenEventShop"; }
	virtual Action* createAction()  { return new ActionRegenEventShop(); }
};
