...
// 
////////////////////////////////////////////////////////////////////////////////
void ActionDeleteGetItem::read (PropertyBuffer & propertyBuffer)
...
// 액션을 실행한다.
////////////////////////////////////////////////////////////////////////////////
void ActionDeleteGetItem::execute (Creature * pCreature1 , Creature * pCreature2) 
...
// get debug string
////////////////////////////////////////////////////////////////////////////////
string ActionDeleteGetItem::toString () const 
	throw ()
{
	__BEGIN_TRY

	StringStream msg;
	msg << "ActionDeleteGetItem("
	    << ")";
