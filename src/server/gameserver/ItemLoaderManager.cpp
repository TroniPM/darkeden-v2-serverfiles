	...
	throw (Error)
{
	...
	m_pItemLoaders[Item::ITEM_CLASS_ETHEREAL] = g_pEtheRealLoader = new EtheRealLoader();
	m_pItemLoaders[Item::ITEM_CLASS_SKILLBOOK] = g_pSkillBookLoader = new SkillBookLoader();
	m_pItemLoaders[Item::ITEM_CLASS_STONE_ABILITY] = g_pStoneAbilityLoader = new StoneAbilityLoader();
	m_pItemLoaders[Item::ITEM_CLASS_NECKLACEZAP] = g_pNecklaceZapLoader = new NecklaceZapLoader();
	m_pItemLoaders[Item::ITEM_CLASS_COATZAP] = g_pCoatZapLoader = new CoatZapLoader();
	m_pItemLoaders[Item::ITEM_CLASS_BOOTZAP] = g_pBootZapLoader = new BootZapLoader();
	m_pItemLoaders[Item::ITEM_CLASS_WEAPONZAP] = g_pWeaponZapLoader = new WeaponZapLoader();
	m_pItemLoaders[Item::ITEM_CLASS_HELMZAP] = g_pHelmZapLoader = new HelmZapLoader();
	m_pItemLoaders[Item::ITEM_CLASS_BELTZAP] = g_pBeltZapLoader = new BeltZapLoader();
	m_pItemLoaders[Item::ITEM_CLASS_GLOVEZAP] = g_pGloveZapLoader = new GloveZapLoader();
	m_pItemLoaders[Item::ITEM_CLASS_SHOESZAP] = g_pShoesZapLoader = new ShoesZapLoader();
	m_pItemLoaders[Item::ITEM_CLASS_COMMON_ITEM] = g_pCommonItemLoader = new CommonItemLoader();
	m_pItemLoaders[Item::ITEM_CLASS_SLAYER_TUNING_ITEM] = g_pSlayerTuningItemLoader = new SlayerTuningItemLoader();
	m_pItemLoaders[Item::ITEM_CLASS_VAMPIREWING_ITEM] = g_pVampireWingItemLoader = new VampireWingItemLoader();
	m_pItemLoaders[Item::ITEM_CLASS_OUSTERSWING_ITEM] = g_pOustersWingItemLoader = new OustersWingItemLoader();
	m_pItemLoaders[Item::ITEM_CLASS_VAMPIRE_TUNING_ITEM] = g_pVampireTuningItemLoader = new VampireTuningItemLoader();
	m_pItemLoaders[Item::ITEM_CLASS_OUSTERS_TUNING_ITEM] = g_pOustersTuningItemLoader = new OustersTuningItemLoader();
	__END_CATCH
}
	...
	throw (Error)
{
	...
	g_pEtheRealLoader->load(pSlayer);
	g_pSkillBookLoader->load(pSlayer);
	g_pStoneAbilityLoader->load(pSlayer);
	g_pNecklaceZapLoader->load(pSlayer);
	g_pCoatZapLoader->load(pSlayer);
	g_pBootZapLoader->load(pSlayer);
	g_pWeaponZapLoader->load(pSlayer);
	g_pHelmZapLoader->load(pSlayer);
	g_pBeltZapLoader->load(pSlayer);
	g_pGloveZapLoader->load(pSlayer);
	g_pShoesZapLoader->load(pSlayer);
	g_pSlayerTuningItemLoader->load(pSlayer);
	g_pCommonItemLoader->load(pSlayer);
	__END_CATCH
}
	...
	throw (Error)
{
	...
	g_pEtheRealLoader->load(pVampire);
	g_pSkillBookLoader->load(pVampire);
	g_pStoneAbilityLoader->load(pVampire);
	g_pNecklaceZapLoader->load(pVampire);
	g_pCoatZapLoader->load(pVampire);
	g_pWeaponZapLoader->load(pVampire);
	g_pCommonItemLoader->load(pVampire);
	g_pVampireWingItemLoader->load(pVampire);
	g_pVampireTuningItemLoader->load(pVampire);
	__END_CATCH
}
	...
	throw (Error)
{
	...
	g_pEtheRealLoader->load(pOusters);
	g_pSkillBookLoader->load(pOusters);
	g_pStoneAbilityLoader->load(pOusters);
	g_pNecklaceZapLoader->load(pOusters);
	g_pCoatZapLoader->load(pOusters);
	g_pBootZapLoader->load(pOusters);
	g_pWeaponZapLoader->load(pOusters);
	g_pHelmZapLoader->load(pOusters);
	g_pBeltZapLoader->load(pOusters);
	g_pCommonItemLoader->load(pOusters);
	g_pOustersWingItemLoader->load(pOusters);
	g_pOustersTuningItemLoader->load(pOusters);
	__END_CATCH
}
