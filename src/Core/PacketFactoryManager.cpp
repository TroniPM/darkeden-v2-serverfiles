...
#include "Cpackets/CGLoadingReady.h"
...
#include "Cpackets/CGLoadingGearReady.h"
//end
#ifndef __GAME_CLIENT__
...
//add by viva 2008-12-31
	...
	addFactory(  new GCLoadInventoryFactory());
	addFactory(  new CGLoadingReadyFactory());
	addFactory(  new GCLoadGearFactory());
	addFactory(  new CGLoadingGearReadyFactory());
