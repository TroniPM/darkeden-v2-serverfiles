	...
	
{
	...
	pPacket->setOptionType2(pItem->getOptionTypeList2());
	...
	pPacket->setHeroOption(pItem->getHeroOption());
	pPacket->setHeroOptionAttr(pItem->getHeroOptionAttr());
	pPacket->clearList();
