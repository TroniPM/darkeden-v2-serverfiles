...
public :
    ...
    uint writeEncrypt (bool   buf)  { buf = m_Encrypter.convert(buf); return write(buf); }
    uint writeEncrypt (char   buf)  { buf = m_Encrypter.convert(buf); return write(buf); }
    uint writeEncrypt (uchar  buf)  { buf = m_Encrypter.convert(buf); return write(buf); }
    uint writeEncrypt (short  buf)  { buf = m_Encrypter.convert(buf); return write(buf); }
    uint writeEncrypt (ushort buf)  { buf = m_Encrypter.convert(buf); return write(buf); }
    uint writeEncrypt (int    buf)  { buf = m_Encrypter.convert(buf); return write(buf); }
    uint writeEncrypt (uint   buf)  { buf = m_Encrypter.convert(buf); return write(buf); }
    uint writeEncrypt (long   buf)  { buf = m_Encrypter.convert(buf); return write(buf); }
    uint writeEncrypt (ulong  buf)  { buf = m_Encrypter.convert(buf); return write(buf); }
