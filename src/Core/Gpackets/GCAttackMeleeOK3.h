...
public :
	...
	// get packet id
	PacketID_t getPacketID()  { return PACKET_GC_ATTACK_MELEE_OK_3; }
	...
	// get packet's name
	string getPacketName()  { return "GCAttackMeleeOK3"; }
...
public :
	...
	// get packet id
	PacketID_t getPacketID()  { return Packet::PACKET_GC_ATTACK_MELEE_OK_3; }
