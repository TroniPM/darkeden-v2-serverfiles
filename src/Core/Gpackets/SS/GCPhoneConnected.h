...
public :
	...
	// get packet id
	PacketID_t getPacketID()  { return PACKET_GC_PHONE_CONNECTED; }
	...
	// get packet's name
	string getPacketName()  { return "GCPhoneConnected"; }
...
public :
	...
	// get packet id
	PacketID_t getPacketID()  { return Packet::PACKET_GC_PHONE_CONNECTED; }
