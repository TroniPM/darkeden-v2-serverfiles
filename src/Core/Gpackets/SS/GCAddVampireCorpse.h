...
public :
	...
	// get packet id
	PacketID_t getPacketID()  { return PACKET_GC_ADD_VAMPIRE_CORPSE; }
	
	// get packet's body size
	PacketSize_t getPacketSize()  { return m_VampireInfo.getSize() + szBYTE; }
...
public :
	...
	// get packet id
	PacketID_t getPacketID()  { return Packet::PACKET_GC_ADD_VAMPIRE_CORPSE; }

	// get packet's body size
	PacketSize_t getPacketMaxSize()  { return PCVampireInfo3::getMaxSize() + szBYTE; }
