...
public :
	...
	// get packet id
	PacketID_t getPacketID()  { return PACKET_GC_PARTY_POSITION; }
	
	// get packet's body size
	// *OPTIMIZATION HINT*
	// const static GCPartyPositionPacketSize 를 정의, 리턴하라.
	PacketSize_t getPacketSize()  { return szBYTE + m_Name.size() + szZoneID + szZoneCoord*2 + szHP*2; }
...
public :
	...
	// get packet id
	PacketID_t getPacketID()  { return Packet::PACKET_GC_PARTY_POSITION; }

	// get packet's max body size
	// *OPTIMIZATION HINT*
	// const static GCPartyPositionPacketSize 를 정의, 리턴하라.
	PacketSize_t getPacketMaxSize()  { return szBYTE + 20 + szZoneID + szZoneCoord*2 + szHP*2; }
