...
public :
	...
	// get packet id
	PacketID_t getPacketID()  { return PACKET_GC_THROW_BOMB_OK_1; }
	
	// get packet's body size
	// 최적화시, 미리 계산된 정수를 사용한다.
	PacketSize_t getPacketSize()  { return szCoord* 2
...
public :
	...
	// get packet id
	PacketID_t getPacketID()  { return Packet::PACKET_GC_THROW_BOMB_OK_1; }

	// get Packet Max Size
	PacketSize_t getPacketMaxSize()  { return szCoord* 2
