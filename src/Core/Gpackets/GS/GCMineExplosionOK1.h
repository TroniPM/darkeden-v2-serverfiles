...
public :
	...
	// get packet id
	PacketID_t getPacketID()  { return PACKET_GC_MINE_EXPLOSION_OK_1; }
	...
	// get packet's name
	string getPacketName()  { return "GCMineExplosionOK1"; }
...
public :
	...
	// get packet id
	PacketID_t getPacketID()  { return Packet::PACKET_GC_MINE_EXPLOSION_OK_1; }
