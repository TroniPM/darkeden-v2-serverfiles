...
public:
    ...
    ItemType_t	getMotorItemType() const
    {
        return m_MotorItemType;
    }
    void setMotorItemType( ItemType_t ItemType )
    {
        m_MotorItemType = ItemType;
    }

    ItemType_t	getJacketItemType() const
    {
        return m_JacketItemType;
    }
    void setJacketItemType( ItemType_t ItemType )
    {
